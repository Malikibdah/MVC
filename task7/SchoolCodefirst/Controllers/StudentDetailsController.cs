...
namespace SchoolCodefirst.Controllers
{
    public class StudentDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FullName,Email,Phonenumber,Address")] StudentDetails studentDetails)
        {
            ...
            ViewBag.Id = new SelectList(db.Students, "ID", "Name", studentDetails.Id);
            return View(studentDetails);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FullName,Email,Phonenumber,Address")] StudentDetails studentDetails)
        {
            if (ModelState.IsValid)
            {
